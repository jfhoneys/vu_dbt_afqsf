...
(select
    ...
    , contact.mailingpostalcode contact_mailing_postal_code 
    , contact.mailingcountry contact_mailing_country 
    , contact.mailinglatitude contact_mailing_latitude 
    , contact.mailinglongitude contact_mailing_longitude 
