...
(select
 employment.aqb__employment__c_id as employment_employment_id
-- , employment.ownerid as employment_ownerid
, employment.isdeleted as employment_isdeleted
, employment.name as employment_name
, employment.recordtypeid as employment_recordtypeid
...
-- , employment.aqb__assistant_s_email__c as employment_assistant_s_email
-- , employment.aqb__assistant_s_name__c as employment_assistant_s_name
-- , employment.aqb__assistant_s_phone__c as employment_assistant_s_phone
, employment.aqb__businessphone__c as employment_businessphone
, employment.aqb__contactid__c as employment_contactid
...
, employment.aqb__employernamedisplay__c as employment_employernamedisplay
-- , employment.aqb__employername__c as employment_employername
, employment.aqb__employmentcomment__c as employment_employmentcomment
, employment.aqb__employmentexternalid__c as employment_employmentexternalid
, employment.aqb__enddate__c as employment_enddate
...
-- , employment.aqcv_conversionid__c as employment_aqcv_conversionid
...
final as (select -- select count(1) as cnt from trans
        ...
        from employment_transform
             join owner on employment_transform.employment_ownerid = owner.user_id
             join created_by on employment_transform.employment_createdbyid = created_by.user_id
             join last_modified_by on employment_transform.employment_lastmodifiedbyid = last_modified_by.user_id
)
